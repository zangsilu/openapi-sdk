 ...
 */
class Vendor_Shopping_Freight extends Vendor_Api
{
    /**
     * 计算运费 GetFreightageCosts
     *
     ...
     * @return mixed
     */
    public function getFreightageCosts($criteria)
    {
        $criteria['Act'] = 'GetFreightageCosts';
